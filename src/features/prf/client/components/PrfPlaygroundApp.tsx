import { closeModal, openModalWithJSX } from "@shared/lib/modal/base.js";
import {
  getPrfAnimationEnabled,
  PRF_ANIMATION_STORAGE_KEY,
} from "@shared/lib/prfAnimationPreference.js";
import { prfClient } from "@shared/lib/rpc/prfClient.js";
import { webauthnClient } from "@shared/lib/rpc/webauthnClient.js";
import {
  clearWebAuthnRequest,
  handleWebAuthnAbort,
  isAbortError,
  startWebAuthnRequest,
} from "@shared/lib/webauthnAbort.js";
import { LoadingIndicator } from "@shared/ui/components/LoadingIndicator.js";
import { showStatusToast } from "@shared/ui/components/StatusToast.js";
import {
  badgeClass,
  buttonClass,
  inputFieldClass,
